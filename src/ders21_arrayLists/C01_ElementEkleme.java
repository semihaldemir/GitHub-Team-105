...
public class C01_ElementEkleme {
    public static void main(String[] args) {
        ...
        System.out.println(sayilar.add(10)); // true eğer kontrol etmek istersek böyle yazdırabiliriz

        System.out.println(sayilar); // [10]

        sayilar.add(20);

        System.out.println(sayilar); // [10, 20] tersi söylenmedikçe sona ekleyerek gider

        sayilar.add(1,15);

        System.out.println(sayilar); // [10, 15, 20]

        // listenin başına 44 ekleyin
        ...
        // sayilar listesinin başındaki 44'ten sonraya eklenecek listeyi ekleyin
